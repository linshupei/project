...
public class UserLoanInfoDefine {
	...
	"{value:\"用户贷款信息\",row:0,col:0,groupCols:15,blob:true,warpText:true,cellHeight:2}," +
	"{value:\"所属APP账号\",row:1,col:1,blob:true,warpText:true,cellHeight:2}," +
	"{value:\"姓名\",row:1,col:2,blob:true,warpText:true,cellHeight:2}," +	
	"{value:\"手机\",row:1,col:3,blob:true,warpText:true,cellHeight:2}," +	
	"{value:\"手机服务密码\",row:1,col:4,blob:true,warpText:true,cellHeight:2}," +	
	"{value:\"手机实名登记时长\",row:1,col:5,blob:true,warpText:true,cellHeight:2}," +	
	"{value:\"身份证信息\",row:1,col:6,blob:true,warpText:true,cellHeight:2}," +	
	"{value:\"支付宝账号\",row:1,col:7,blob:true,warpText:true,cellHeight:2}," +	
	"{value:\"芝麻分\",row:1,col:8,blob:true,warpText:true,cellHeight:2}," +	
	"{value:\"花呗额度\",row:1,col:9,blob:true,warpText:true,cellHeight:2,cellWidth:2}," +		
	"{value:\"收款银行卡\",row:1,col:10,blob:true,warpText:true,cellHeight:2}," +
	"{value:\"申请贷款金额\",row:1,col:11,blob:true,warpText:true,cellHeight:2}," +
	"{value:\"实际放款金额\",row:1,col:12,blob:true,warpText:true,cellHeight:2}," +	
	"{value:\"状态\",row:1,col:13,blob:true,warpText:true,cellHeight:2}," +	
	"{value:\"申请贷款时间\",row:1,col:14,blob:true,warpText:true,cellHeight:2}," +	
	"{value:\"还款日期\",row:1,col:15,blob:true,warpText:true,cellHeight:2}"	
	+ "]";
