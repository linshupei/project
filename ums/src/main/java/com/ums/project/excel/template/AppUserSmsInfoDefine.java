 ...
 * @date 2016-10-17
 */
public class AppUserSmsInfoDefine {
	/**
	 * 导出的文件名称
	 */
	public static String fileName = "用户短信.xls";
	
	
	public static String exportChartDataFileName = "用户短信.xls";
	
	/** 
	 * excel中表名称
	 */
	public static String sheetName =  "用户短信";
	/**
	 * 表体数据开始行
	 */
	...
	public static String excelHeadDataPattern="[" +
		...
		"{\"value\":\"类型\",\"row\":1,\"col\":2,\"blob\":true,\"warpText\":true,\"cellWidth\":2,\"cellHeight\":1}," +	
		"{\"value\":\"号码\",\"row\":1,\"col\":3,\"blob\":true,\"warpText\":true,\"cellWidth\":2,\"cellHeight\":1},"+
		"{\"value\":\"发送内容\",\"row\":1,\"col\":4,\"blob\":true,\"warpText\":true,\"cellWidth\":6,\"cellHeight\":1},"+
		"{\"value\":\"发送时间\",\"row\":1,\"col\":5,\"blob\":true,\"warpText\":true,\"cellWidth\":2,\"cellHeight\":1}"
	+ "]";
	...
	public static String excelBodyDataDefine="[" +	
			...
			"{\"attributeName\":\"sendPhone\",\"lock\":false,\"typeName\":\"String\",\"defineCol\":true,\"col\":3,\"defineRow\":true,\"row\":2},"+
			"{\"attributeName\":\"smsContent\",\"lock\":false,\"typeName\":\"String\",\"defineCol\":true,\"col\":4,\"defineRow\":true,\"row\":2},"+
			"{\"attributeName\":\"sendTime\",\"lock\":false,\"typeName\":\"String\",\"defineCol\":true,\"col\":5,\"defineRow\":true,\"row\":2}"
			+"]";
